...
import io.trino.tracing.plugin.TracingPlugin;
...
public final class TracingQueryRunner
{
    private TracingQueryRunner() {}
            ...
            extends DistributedQueryRunner.Builder<Builder>
    {
                ...
                throws Exception
        {
            ...
            try {
                queryRunner.installPlugin(new TracingPlugin());
