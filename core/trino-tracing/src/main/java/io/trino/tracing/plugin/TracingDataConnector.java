...
public class TracingDataConnector
        implements Connector
{
    private final TracingDataMetadata metadata;
    private final TelemetryStore telemetryStore;

    @Inject
    public TracingDataConnector(TracingDataMetadata metadata, TelemetryStore telemetryStore)
    {
    ...
    {
        return new TracingDataSplitManager();
    }

    @Override
    public ConnectorTransactionHandle beginTransaction(IsolationLevel isolationLevel, boolean readOnly, boolean autoCommit)
    {
        return TracingDataTransactionHandle.INSTANCE;
    }
